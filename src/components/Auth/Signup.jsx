...
export default function Signup() {
    ...
    const signupSuccess = () => navigate("/signupSuccess")
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-8 py-12">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="flex gap-4" >
              ...
              <button type="submit" className="w-full py-3 bg-[var(--theme-color)] text-white rounded-md hover:bg-white border border-[var(--theme-color)] hover:text-[var(--theme-color)] transition" onClick={signupSuccess}>
                Continue
              </button>
