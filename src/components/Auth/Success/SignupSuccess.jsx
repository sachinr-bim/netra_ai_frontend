    ...
    <div className="flex bg-white min-h-screen">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-8 py-12">
            ...
            <div className="w-full max-w-md">
              <h2 className="text-3xl font-bold mb-1">Successfull Signup</h2>
              <p className="text-gray-500 mb-6">You can now log in to your account</p>
    
              <button type="submit" className="w-full py-3 bg-[var(--theme-color)] text-white font-Georgia rounded-md hover:bg-white border border-[var(--theme-color)] hover:text-[var(--theme-color)] transition" onClick={() => navigate('/subscription')} >
                  Get Started
              </button>
