...
export default function PaymentHistory() {
  ...
  return (
    <div className="bg-gray-100 p-3 xs:p-4 sm:p-4 md:p-6">
      {/* Header with Title and Filter Button - Original Alignment Maintained */}
      <div className="flex justify-between items-center mb-4 md:mb-6">
        <h1 className="text-lg xs:text-xl sm:text-xl md:text-2xl font-semibold">Payment History</h1>
        <button 
          onClick={() => setShowFilters(!showFilters)}
          className="text-[var(--theme-color)] border border-[var(--theme-color)] shadow-sm rounded-md px-3 xs:px-4 sm:px-4 md:px-6 py-1.5 text-xs xs:text-sm sm:text-sm md:text-base hover:bg-[var(--theme-color)] hover:text-white transition-colors whitespace-nowrap"
        >
      ...
      <div className="bg-white mb-4 md:mb-6 p-3 xs:p-4 sm:p-4 md:p-6 rounded-md">
